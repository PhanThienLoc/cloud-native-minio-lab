...
## Mục tiêu sửa
Branch `feat/data-ingestion-pipeline` đã đi đúng hướng tuần 1: tạo script sinh dataset mẫu cho MinIO Lab. Tuy nhiên branch cũ đang commit trực tiếp dữ liệu sinh ra vào Git và thiếu dependency cần thiết để người khác chạy lại script.
